...
//	vec3 rgb = vec3(0.7, 0.7, 0.7);
//	vec3 rgb = min(texColour.rgb * scatteredLight, vec3(1.0));
	FragColour = vec4(rgb, texColour.a);

//	vec3 col = vec3(1, 1, 0);

//	vec3 rgb = min(col * scatteredLight + reflectedLight, vec3(1.0));
//	vec3 rgb = min(col * scatteredLight + reflectedLight, vec3(1.0));
//	vec3 rgb = min(col, vec3(1.0));

//	FragColour = vec4(rgb, 1);
